...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = input_bram_ctrl
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = intc
 PARAMETER DRIVER_VER = 3.11
 PARAMETER HW_INSTANCE = inter_cont
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = mlp_conv
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = mlp_conv_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.4
 PARAMETER HW_INSTANCE = output_bram_ctrl
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = system_dma
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.4
 PARAMETER HW_INSTANCE = weight_bram_ctrl
END
